...
def test_modules():
    ...
    try:
        ...
        # Test saving entry
        entry_id = data_manager.save_entry("testuser", 120.5, "Oatmeal with berries", "30 min walk", "2024-01-15")
        ...
        recommendation = ai_engine.get_recommendation("testuser", 120.5, "Oatmeal", "Walking")
...
def test_flask_app():
    ...
    try:
        ...
        with app.test_client() as client:
            ...
            assert response.status_code == 400, "Register route should return 400 for missing data"
            print("✅ Register route exists")
            
            response = client.post('/api/login')
            assert response.status_code == 400, "Login route should return 400 for missing data"
